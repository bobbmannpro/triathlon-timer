...
export default function App() {
  ...
  // Reset all timers but keep names
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
                ...
                <tbody>
                  {sorted.map((ath, place) => {
                    ...
                    return (
                      <tr key={ath.id} style={{ borderBottom: "1px solid rgba(255,255,255,0.05)", background: place === 0 ? "rgba(74,222,128,0.05)" : "transparent" }}>
